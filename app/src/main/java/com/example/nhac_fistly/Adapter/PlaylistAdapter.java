...
public class PlaylistAdapter extends ArrayAdapter<Playlist> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        Picasso.with(getContext()).load(playlist.getHinhNenPlayList()).into(viewHolder.imgbackground);
        Picasso.with(getContext()).load(playlist.getInconPlayList()).into(viewHolder.imgplaylist);
